...
def nuvol (px,py):
        arcade.draw_circle_filled(100+px, 495+py, 30, arcade.csscolor.WHITE)
        arcade.draw_circle_filled(140+px, 500+py, 30, arcade.csscolor.WHITE)
        arcade.draw_circle_filled(115+px, 515+py, 30, arcade.csscolor.WHITE)
        arcade.draw_circle_filled(85+px, 510+py, 30, arcade.csscolor.WHITE)
def nuvol2 (px,py):
        arcade.draw_circle_filled(100+px, 495+py, 30, arcade.csscolor.WHITE)
        arcade.draw_circle_filled(140+px, 500+py, 30, arcade.csscolor.WHITE)
        arcade.draw_circle_filled(115+px, 515+py, 30, arcade.csscolor.WHITE)
