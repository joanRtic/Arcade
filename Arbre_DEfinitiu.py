...
def nuvol (x,y):
        arcade.draw_circle_filled(100, 495, 30, arcade.csscolor.WHITE)
        arcade.draw_circle_filled(140, 500, 30, arcade.csscolor.WHITE)
        arcade.draw_circle_filled(115, 515, 30, arcade.csscolor.WHITE)
        arcade.draw_circle_filled(85, 510, 30, arcade.csscolor.WHITE)
...
arcade.draw_ellipse_filled(180, 140, 170, 80, arcade.csscolor.BLUE, 3)
# Finish drawing
